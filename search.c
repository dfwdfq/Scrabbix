  ...
  while(current != NULL)
    {
      ...
      search_word(rword,LEFT,current->x,current->y);
      ...
      */
      ...
      search_word(rword,RIGHT,current->x,current->y);
      ...
      */
      ...
      search_word(rword,UP,current->x,current->y);
      ...
      */
      ...
      search_word(rword,DOWN,current->x,current->y);
